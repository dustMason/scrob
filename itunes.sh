...
send_scrobble(){
  ...
  curl -i -X POST --data 'user='"$creds"'&title='"$current_track_name"'&artist='"$current_artist_name"'&album='"$current_album_name"'&rating='"$current_track_rating"'' "https://dizouble.com/music"
}
